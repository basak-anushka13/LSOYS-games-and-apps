...
export function PackTile({
  ...
  const palette: Record<PackType, { bg: string; ring: string; glow: string }> =
    {
      Bronze: {
        bg: "from-orange-300/70 via-amber-500/80 to-amber-800/80",
        ring: "ring-amber-300/70",
        glow: "shadow-[0_0_60px_rgba(245,158,11,0.5)]",
      },
      Silver: {
        bg: "from-slate-200/80 via-slate-400/70 to-slate-700/80",
        ring: "ring-slate-200/80",
        glow: "shadow-[0_0_60px_rgba(203,213,225,0.5)]",
      },
      Gold: {
        bg: "from-yellow-200/90 via-amber-400/90 to-orange-700/90",
